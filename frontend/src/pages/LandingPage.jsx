    ...
    <div className="flex-grow flex items-center justify-center">
      <div className="bg-[#313335] p-8 rounded-lg border border-[#4e5254] shadow-2xl w-full max-w-md">
        ...
        <div className="mb-8 text-center">
            <h1 className="text-2xl font-bold text-white mb-2">Configure Data Sources</h1>
            <p className="text-sm text-[#808080]">Enter your competitive programming handles</p>
        </div>
